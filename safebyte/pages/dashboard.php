...
<body>
    ...
    <?php if ($is_subscribed): ?>
        ...
        <div class="download-section">
            ...
            <p style="color: #d4edda; margin-bottom: 15px;">Your subscription is active. Download your personalized VPN configuration file:</p>
            <a href="<?php echo $config_link; ?>" download class="download-button">📥 Download VPN Config</a>
